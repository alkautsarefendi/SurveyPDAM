...
public class ImportSPKOAdapter extends BaseAdapter {
    ...
    public ImportSPKOAdapter(Activity activity, List<TSurvey> listSurvey) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Log.v("aaaaaa", "Data ke "+position);

        if (inflater == null)
            inflater = (LayoutInflater) activity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        if (convertView == null)
            convertView = inflater.inflate(R.layout.activity_import_spko_adapter, parent, false);
